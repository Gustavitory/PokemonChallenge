    ...
    return (
        ...
        {pokemon?.map((pokemon) => (
            <Card key={pokemon.id} className={selectType(pokemon.types[0])}>
                ...
                <ImgContainer>
                <Caption>Shiny: </Caption>
                    <div>
                        {pokemon.imageFrontShiny ? 
                        <Pic src={pokemon.imageFrontShiny} alt={pokemon.name}/>
                        :
                        null
                        }
                    </div>
                    <div>
                        {pokemon.imageBackShiny ? 
                        <Pic src={pokemon.imageBackShiny} alt={pokemon.name}/>
                        :
                        null
                        }
                    </div>
                ...
                <div>
                    <Caption><Icon src='https://api.iconify.design/clarity:heart-solid.svg'/>HP {pokemon.hp}</Caption>
